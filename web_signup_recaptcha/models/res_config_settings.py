...
class ResConfigSettings(models.TransientModel):
    ...
    signup_google_recaptcha = fields.Boolean(string="Signup Recaptcha")
    ...
    def get_values(self):
        ...
        res.update(signup_google_recaptcha=params.get_param('signup_google_recaptcha'),
    ...
    def set_values(self):
        ...
        params = self.env['ir.config_parameter'].sudo()
        params.set_param('signup_google_recaptcha', self.signup_google_recaptcha)
